...
def dataset_to_model_path(dataset):
    ...
    model_path = f"/fs/scratch/PAS2099/camera-trap-final/logs/{dataset_underscore}/upper_bound_ce_loss/lr_0.000025/bioclip2/full_text_head/log/pretrain_best_model.pth"
    if not os.path.exists(model_path):
        model_path = f"/fs/scratch/PAS2099/camera-trap-final/logs/{dataset_underscore}/upper_bound_ce_loss/bioclip2/full_text_head/log/pretrain_best_model.pth"
    return model_path
