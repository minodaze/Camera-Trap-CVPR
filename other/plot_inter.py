...
ax.plot(x, zs, marker='o', color='skyblue', label='zs')
ax.scatter(x, ub, marker='s', color='orange', label='oracle')
ax.scatter(x, a08, marker='^', color='blue', label=r'$\alpha=0.8$')
...
ax.legend(title="Interpolation Coefficient Effect", loc='upper center',
          bbox_to_anchor=(0.5, 1.15), ncol=3, frameon=True)
fig.tight_layout()
