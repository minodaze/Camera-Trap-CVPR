...
def generate_plot():
    ...
    s3 = pd.to_numeric(df3["best oracle - zs"], errors="coerce")
    ...
    plt.ylabel("Best Oracle Accuracy - ZS Accuracy", fontsize=16, fontweight="bold")
    plt.tight_layout()
    plt.savefig("other/oracle_vs_zs_combined.png", dpi=220)
    print("Plot saved to other/oracle_vs_zs_combined.png")
    plt.close()
