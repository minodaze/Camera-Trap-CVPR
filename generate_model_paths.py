import os
with open('uselist/eval_dataset.txt', 'r') as file:
...
for ds in datasets:
    ...
    model_path = f'/fs/scratch/PAS2099/camera-trap-ECCV/ascend3/best_accum/{ds}/bioclip2/lora_8_text_head_loss_bsm/all/log'
