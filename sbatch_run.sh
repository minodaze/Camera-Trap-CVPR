...
#SBATCH --job-name=bioclip2_zs_batch
...
CSV_PATH="/users/PAS2099/${USER_NAME}/Documents/icicle/ICICLE-Benchmark/balanced_accuracy_common.csv"
mkdir -p $CONFIG_ROOT
...
")
    CONFIG_FILE="${CONFIG_ROOT}/${DATASET//\//_}_percentage-1.yaml"
    cat <<EOF > $CONFIG_FILE
...
EOF
    ...
    # BASE_LOG_DIR="/fs/scratch/PAS2099/${USER_NAME}/icicle/log_auto/pipeline/${DATASET//\//_}/upper_bound/${PARENT_TIMESTAMP}/"
