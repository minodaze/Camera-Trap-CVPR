...
EOF
    ...
    for alpha in "${interpolation_alpha[@]}"; do
        ...
        python run_pipeline.py --c $CONFIG_FILE --eval_per_epoch --save_best_model --eval_only --model_dir "${MODEL_DIR}" --pretrained_weights bioclip2 --lora_bottleneck 8 --merge_factor ${alpha}
    done
