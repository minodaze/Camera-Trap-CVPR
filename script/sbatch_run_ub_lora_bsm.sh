...
# ")
    ...
    mkdir -p "/fs/scratch/PAS2099/camera-trap-final/best_oracle_logs/${DATASET//\//_}/oracle_lora_bsm_loss/"

    cat <<EOF > $CONFIG_FILE
module_name: upper_bound
log_path: /fs/scratch/PAS2099/camera-trap-final/best_oracle_logs/${DATASET//\//_}/oracle_lora_bsm_loss/
