...
# ")
    ...
    mkdir -p "/fs/scratch/PAS2099/camera-trap-final/best_oracle_inter_logs/${DATASET//\//_}/oracle_lora_bsm_loss/"

    cat <<EOF > $CONFIG_FILE
module_name: upper_bound
log_path: /fs/scratch/PAS2099/camera-trap-final/best_oracle_inter_logs/${DATASET//\//_}/oracle_lora_bsm_loss/
...
EOF
    ...
    python run_pipeline.py --c $CONFIG_FILE --plot_features --wandb --eval_per_epoch --save_best_model --pretrained_weights bioclip2 --lora_bottleneck 8 --lora_interpolate
