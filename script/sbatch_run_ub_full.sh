...
# ")
    ...
    mkdir -p "/fs/scratch/PAS2099/camera-trap-final/dataAnalysis_logs/${DATASET//\//_}/upper_bound_ce_loss/"

    cat <<EOF > $CONFIG_FILE
module_name: upper_bound
log_path: /fs/scratch/PAS2099/camera-trap-final/dataAnalysis_logs/${DATASET//\//_}/upper_bound_ce_loss/
