...
# ")
    ...
    mkdir -p "/fs/scratch/PAS2099/camera-trap-final/dataAnalysis_logs/${DATASET//\//_}/zs/"

    cat <<EOF > $CONFIG_FILE
module_name: zs
log_path: /fs/scratch/PAS2099/camera-trap-final/dataAnalysis_logs/${DATASET//\//_}/zs/
