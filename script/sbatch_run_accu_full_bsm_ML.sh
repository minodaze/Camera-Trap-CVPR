...
# ")
    ...
    mkdir -p "/fs/scratch/PAS2099/camera-trap-final/ML_logs/${DATASET//\//_}/accum_full_bsm_loss/"

    cat <<EOF > $CONFIG_FILE
module_name: accumulative-scratch
log_path: /fs/scratch/PAS2099/camera-trap-final/ML_logs/${DATASET//\//_}/accum_full_bsm_loss/
