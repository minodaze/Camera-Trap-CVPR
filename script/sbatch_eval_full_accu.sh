...
log_path: /fs/scratch/PAS2099/camera-trap-final/eval_logs/${DATASET//\//_}/eval_full_accu/
...
EOF
    ...
    python run_pipeline.py --c $CONFIG_FILE --eval_only --accu_eval --model_dir "${MODEL_DIR}" --pretrained_weights bioclip2 --full
done