import os
with open('/users/PAS2099/mino/ICICLE/uselist/CL_list.txt', 'r') as file:
...
for ds in datasets:
    ...
    model_path = f'/fs/scratch/PAS2099/camera-trap-final/CL_logs/best_derpp/{ds}/bioclip2/lora_8_text_head_loss_derpp_bsm/all/log'
...
with open('/users/PAS2099/mino/ICICLE/uselist/derpp_eval_model_path.txt', 'w') as file:
