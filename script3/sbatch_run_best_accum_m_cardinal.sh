...
#SBATCH --job-name=bioclip2_best_accum_m
...
# ")
    ...
    mkdir -p "/fs/scratch/PAS2099/camera-trap-ECCV/cardinal/best_accum/${DATASET//\//_}"

    cat <<EOF > $CONFIG_FILE
module_name: best_accum_lora_bsm
log_path: /fs/scratch/PAS2099/camera-trap-ECCV/cardinal/best_accum/${DATASET//\//_}
