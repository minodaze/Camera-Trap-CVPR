...
# ")
    ...
    mkdir -p "/fs/scratch/PAS2099/camera-trap-ECCV/cardinal/accum/${DATASET//\//_}"

    cat <<EOF > $CONFIG_FILE
module_name: best_accum_lora_bsm
log_path: /fs/scratch/PAS2099/camera-trap-ECCV/cardinal/accum/${DATASET//\//_}
...
EOF
    ...
    python run_pipeline.py --c $CONFIG_FILE --resume --wandb --eval_per_epoch --save_best_model --pretrained_weights bioclip2 --full --loss_type ce
