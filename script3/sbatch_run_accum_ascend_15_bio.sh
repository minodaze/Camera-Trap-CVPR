...
# ")
    ...
    mkdir -p "/fs/scratch/PAS2099/camera-trap-ECCV/ascend3/accum_15_bio/${DATASET//\//_}"

    cat <<EOF > $CONFIG_FILE
module_name: best_accum
log_path: /fs/scratch/PAS2099/camera-trap-ECCV/ascend3/accum_15_bio/${DATASET//\//_}
...
EOF
    ...
    python run_pipeline.py --c $CONFIG_FILE --text_template bioclip --resume --wandb --eval_per_epoch --save_best_model --pretrained_weights bioclip2 --full --loss_type ce
