...
# ")
    ...
    mkdir -p "/fs/scratch/PAS2099/camera-trap-ECCV/ascend3/wildclip_zs_openai/${DATASET//\//_}"

    cat <<EOF > $CONFIG_FILE
module_name: zs
log_path: /fs/scratch/PAS2099/camera-trap-ECCV/ascend3/wildclip_zs_openai/${DATASET//\//_}
common_config:
  model: bioclip2
