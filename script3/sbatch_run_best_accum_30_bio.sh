...
for DATASET in "${BIG_FOLDERS[@]}"; do
    ...
    mkdir -p "/fs/scratch/PAS2099/camera-trap-ECCV/ascend3/best_accum_30_bio/${DATASET//\//_}"

    cat <<EOF > $CONFIG_FILE
module_name: best_accum_lora_bsm
log_path: /fs/scratch/PAS2099/camera-trap-ECCV/ascend3/best_accum_30_bio/${DATASET//\//_}
