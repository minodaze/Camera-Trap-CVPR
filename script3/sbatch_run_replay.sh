...
for DATASET in "${BIG_FOLDERS[@]}"; do
    ...
    mkdir -p "/fs/scratch/PAS2099/camera-trap-ECCV/ascend3/replay/${DATASET//\//_}"

    cat <<EOF > $CONFIG_FILE
module_name: best_replay_lora_bsm
log_path: /fs/scratch/PAS2099/camera-trap-ECCV/ascend3/replay/${DATASET//\//_}
...
EOF
    ...
    python run_pipeline.py --c $CONFIG_FILE --wandb --eval_per_epoch --test_per_epoch --save_best_model --pretrained_weights bioclip2 --loss_type ce --full
done