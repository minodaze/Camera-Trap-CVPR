...
# ")
    ...
    mkdir -p "/fs/scratch/PAS2099/camera-trap-ECCV/ascend3/speciesnet_accum_openai/${DATASET//\//_}"

    cat <<EOF > $CONFIG_FILE
module_name: best_accum
log_path: /fs/scratch/PAS2099/camera-trap-ECCV/ascend3/speciesnet_accum_openai/${DATASET//\//_}
...
EOF
    ...
    python run_pipeline.py --c $CONFIG_FILE --wandb --eval_per_epoch --save_best_model --pretrained_weights speciesnet --full --loss_type ce
