...
for DATASET in "${BIG_FOLDERS[@]}"; do
    ...
    mkdir -p "/fs/scratch/PAS2099/camera-trap-ECCV/ascend3/best_er1_new/${DATASET//\//_}"

    cat <<EOF > $CONFIG_FILE
module_name: best_replay_lora_bsm
log_path: /fs/scratch/PAS2099/camera-trap-ECCV/ascend3/best_er1_new/${DATASET//\//_}
...
EOF
    ...
    python run_pipeline.py --c $CONFIG_FILE --wandb --device cuda:0 --pretrained_weights bioclip2 --loss_type bsm --lora_bottleneck 8
done