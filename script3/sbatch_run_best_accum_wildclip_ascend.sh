...
# ")
    ...
    mkdir -p "/fs/scratch/PAS2099/camera-trap-ECCV/ascend3/wildclip_best_accum_openai/${DATASET//\//_}"

    cat <<EOF > $CONFIG_FILE
module_name: accum
log_path: /fs/scratch/PAS2099/camera-trap-ECCV/ascend3/wildclip_best_accum_openai/${DATASET//\//_}
...
EOF
    ...
    python run_pipeline.py --c $CONFIG_FILE --wandb --eval_per_epoch --save_best_model --pretrained_weights wildclip --lora_bottleneck 8 --loss_type bsm
