...
# ")
    ...
    mkdir -p "/fs/scratch/PAS2099/camera-trap-ECCV/ascend3/all_class_best_accum/${DATASET//\//_}"

    cat <<EOF > $CONFIG_FILE
module_name: best_accum_lora_bsm
log_path: /fs/scratch/PAS2099/camera-trap-ECCV/ascend3/all_class_best_accum/${DATASET//\//_}
