...
def convert_json_class_names():
    ...
    source_dir = "/users/PAS2119/hou/ICICLE/ICICLE-Benchmark/config/data/ENO/ENO_C05"
    target_dir = "/users/PAS2119/hou/ICICLE/ICICLE-Benchmark/config/data/ENO/ENO_C05_scientific_name"
