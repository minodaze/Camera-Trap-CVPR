...
def convert_json_class_names():
    ...
    source_dir = "/users/PAS2119/hou/ICICLE/ICICLE-Benchmark/config/data/na/na_lebec_CA-14"
    target_dir = "/users/PAS2119/hou/ICICLE/ICICLE-Benchmark/config/data/na/na_lebec_CA-14_common_name"
    ...
    for json_file in json_files:
        ...
        class_conversions = {}  # Track conversions: original -> common_name
            ...
            for entry in entries:
                ...
                if 'class_name' in entry:
                    ...
                    if original_class in mapping:
                        common_name = mapping[original_class]
                        entry['class_name'] = common_name
                        converted_count += 1
                        all_converted_names.add(common_name)
                        
                        # Track the conversion
                        if original_class != common_name:  # Only track if actually different
                            class_conversions[original_class] = common_name
                    else:
        ...
        if class_conversions:
            ...
            for original, common in sorted(class_conversions.items()):
                print(f"    {original} -> {common}")
