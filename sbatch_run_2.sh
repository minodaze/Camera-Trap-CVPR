...
CONFIG_ROOT="/users/PAS2119/hou/ICICLE/ICICLE-Benchmark/config/generated_common"
...
log_path: /users/PAS2119/hou/ICICLE/ICICLE-Benchmark/log/log_auto/pipeline/${DATASET//\//_}/upper_bound/${PARENT_TIMESTAMP}/
